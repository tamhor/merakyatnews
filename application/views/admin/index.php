        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                <div class="d-table m-auto">
                  ...
                  <span class="d-none d-md-inline ml-1">Taxmedia</span>
                </div>
              </a>
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link <?= $this->uri->segment(1) === 'pending' && $this->uri->segment(2) === NULL ? 'active' : '' ?>" href="<?= base_url('pending') ?>">
              ...
              <li class="nav-item">
                <a class="nav-link <?= $this->uri->segment(1) === 'subs'  ? 'active' : '' ?>" href="<?= base_url('subs') ?>">
                  <i class="material-icons">list</i>
                  <span>Subs Category</span>
                </a>
              </li>
              <li class="nav-item">
        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          <footer class="main-footer d-flex p-2 px-3 bg-white border-top">
            <span class="copyright ml-auto my-auto mr-2">Copyright &copy; <?= date('Y') ?>
              <a href="http://tamhor.com" rel="nofollow">Tamhor Dev.</a>
