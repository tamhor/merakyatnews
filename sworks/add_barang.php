...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
	  ...
	  $insert = '1';
		...
		if(($no != null || $no != "") && ($chmod >= 3 || $_SESSION['jabatan'] == 'admin')){
			   ...
			   $sql="select * from $tabeldatabase where no='$no'";
				  ...
				  $jenis_barang = $fill["jenis_barang"];
                  $insert = '3';
	...
	<div id="main">
	 <div class="container-fluid">
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  <label for="kategori" class="col-sm-3 control-label">Jenis Barang:</label>
                  <div class="col-sm-9">
                    <select class="form-control select2" style="width: 100%;" name="jenis_barang">
    					<option <?= ($jenis_barang=="Obat") ? 'selected=selected' : '' ?>  value="Obat">Obat</option>
    					<option <?= ($jenis_barang=="Kosmetik") ? 'selected=selected' : '' ?>  value="Kosmetik">Kosmetik</option>
                    </select>
                  </div>
                </div>
        </div>
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
          ...
          $jenis_barang = mysql_real_escape_string($_POST["jenis_barang"]);
				  $insert = ($_POST["insert"]);
        ...
        $result=mysqli_query($conn,$sql);
              ...
              if(mysqli_num_rows($result)>0){
                  ...
                  $sql1 = "update $tabeldatabase set nama='$nama', hargabeli='$hargabeli', hargajual='$hargajual', kategori='$kategori', jenis_barang='$jenis_barang', keterangan='$keterangan' where kode='$kode'";
          ...
          echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
					 ...
					 $sql2 = "insert into $tabeldatabase values( '$kode','$nama','$hargabeli','$hargajual','$keterangan','$kategori','','','','','$jenis_barang')";
