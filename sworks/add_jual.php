...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
    ...
    if(isset($_POST["tambah"])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
              ...
              $hargabeliakhir = mysql_real_escape_string($_POST["hargabeli"]*$_POST["jumlah"]);
    ...
    if(isset($_POST["simpan"])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $result=mysqli_query($conn,$sql);
               ...
               $sql2 = "insert into bayar values( '$kode','$tglnota','$bayar','$datatotal','$kembalian','$databelitotal','$kasir','')";
               $insertan = mysqli_query($conn, $sql2);
                                  ...
                                  <div class="box-header with-border">
                                   ...
                                   function sum2() {
                                    ...
                                    <div class="row" >
                                              ...
                                              <div class="col-sm-10">
                                                <input type="text" class="form-control" id="bayar" name="bayar" value="<?php echo $bayar; ?>" maxlength="50" placeholder="Masukan Jumlah Dibayar" onkeyup="sum2();">
                                              </div>
                                            </div>
