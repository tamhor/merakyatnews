...
<?php if($tahun != null || $tahun != ""){ ?>
 ...
 $jumlahbayar=$rowa['data'];
   ...
   <td><?php  echo mysql_real_escape_string(number_format($fill['keluar'], $decimal, $a_decimal, $thousand).',-'); ?></td>
   <td><?php  echo mysql_real_escape_string(number_format($fill['total']-$fill['keluar'], $decimal, $a_decimal, $thousand).',-'); ?></td>
